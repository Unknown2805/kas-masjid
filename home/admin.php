			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-12 col-sm-6 col-md-4">	
						...
						<div class="col-12 col-sm-6 col-md-4">
							<div class="info-box mb-3">
							<span class="info-box-icon bg-warning elevation-1"><i class="fas fa-user" style="color:white"></i></span>

							<div class="info-box-content">
								<span class="info-box-text"><a href="?page=MyApp/data_pengguna" class="small-box-footer" style="color:white">Pengguna Sistem</a></span>
								<span class="info-box-number"><a href="?page=MyApp/data_pengguna" class="small-box-footer" style="color:white"><?php echo $jml; ?></a></span>
							</div>
							<!-- /.info-box-content -->
							</div>
							<!-- /.info-box -->
