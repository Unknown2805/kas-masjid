...
<div class="row">
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo rupiah($saldo); ?></span>
				<a href="?page=rekap_km" class="small-box-footer" style="color:black">Selengkapnya<i class="fas fa-arrow-circle-right"></i></a>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo rupiah($ssaldo); ?></span>
				<a href="?page=rekap_ks" class="small-box-footer" style="color:black">Selengkapnya<i class="fas fa-arrow-circle-right"></i></a>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-warning elevation-1" style="color:black"><i class="fas fa-user"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Pengguna Sistem</span>
                <span class="info-box-number"><?php echo $jml; ?></span>
				<a href="?page=MyApp/data_pengguna" class="small-box-footer" style="color:black">Selengkapnya
